...
const headerPilotRegisterClassName =
  "inline-flex h-9 shrink-0 items-center justify-center rounded-full border-2 border-blue-600 bg-blue-600 px-4 text-xs font-semibold tracking-wide text-white shadow-none transition hover:border-blue-700 hover:bg-blue-700 hover:text-white dark:border-blue-500 dark:bg-blue-600 dark:hover:border-blue-400 dark:hover:bg-blue-500";

const headerRegisteredPilotClassName =
  "inline-flex h-9 shrink-0 items-center justify-center whitespace-nowrap rounded-full border-2 border-blue-600 bg-transparent px-3 text-xs font-semibold tracking-wide text-blue-700 shadow-none transition hover:bg-blue-50/70 hover:text-blue-900 dark:border-blue-500 dark:text-blue-400 dark:hover:bg-blue-950/40 dark:hover:text-blue-300";
...
const mobilePilotRegisterClassName =
  "mt-4 w-full rounded-full border-2 border-blue-600 bg-blue-600 font-semibold tracking-wide text-white shadow-none transition hover:border-blue-700 hover:bg-blue-700 hover:text-white dark:border-blue-500 dark:bg-blue-600 dark:hover:border-blue-400 dark:hover:bg-blue-500";

const mobileRegisteredPilotClassName =
  "mt-2 w-full rounded-full border-2 border-blue-600 bg-transparent font-semibold tracking-wide text-blue-700 shadow-none transition hover:bg-blue-50/70 hover:text-blue-900 dark:border-blue-500 dark:text-blue-400 dark:hover:bg-blue-950/40 dark:hover:text-blue-300";
      ...
      <div className="flex w-full min-w-0 items-center gap-2 py-3 pl-2 pr-2 sm:gap-3 sm:pl-3 sm:pr-3 lg:gap-4 lg:pl-4 lg:pr-5">
        ...
        <div className="ml-auto flex min-w-0 flex-1 items-center justify-end gap-2 sm:gap-3 md:gap-4 md:pl-2 lg:pl-4">
          ...
          >
            {nav.map((item) =>
              item.href === "/services" ? (
                <ServiceListingMegaMenu key={item.href} />
