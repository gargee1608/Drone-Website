      ...
      <div className="mx-auto max-w-7xl">
        <div className="mb-10 flex flex-col items-center text-center sm:mb-16 md:mb-24">
          <div className="max-w-2xl">
            ...
            <p className="mt-5 font-[family-name:var(--font-landing-headline)] text-3xl font-bold tracking-tight text-slate-900 sm:text-5xl">
              How It Works?
            </p>
        ...
        <div className="relative grid grid-cols-1 gap-6 md:grid-cols-3 md:gap-7">
          ...
          {steps.map((step, index) => {
            ...
            return (
              <div
                key={step.n}
                className={`group relative z-10 overflow-hidden rounded-3xl border border-[#008B8B]/15 bg-white/90 p-5 text-center shadow-[0_18px_45px_rgba(15,23,42,0.08)] backdrop-blur transition-all duration-300 hover:-translate-y-1 hover:border-[#008B8B]/35 hover:shadow-[0_24px_60px_rgba(0,139,139,0.16)] sm:p-8 ${slideClass}`}
              >
                <div
                ...
                />
                <div
                  className={`relative mx-auto mb-5 flex size-20 items-center justify-center rounded-3xl border bg-[#f4fbfb] transition-transform duration-300 group-hover:scale-105 sm:mb-7 sm:size-28 ${iconRingClass}`}
                >
                  <step.icon
                    className={`size-9 sm:size-12 ${iconColorClass}`}
                    strokeWidth={1.5}
                  />
                  <div className="absolute -right-3 -top-3 flex size-10 items-center justify-center rounded-2xl border border-white bg-[#008B8B] font-[family-name:var(--font-landing-headline)] text-xs font-bold text-white shadow-lg shadow-[#008B8B]/25 sm:size-11">
                    {step.n}
                  </div>
                </div>
                <h4 className="mb-3 font-[family-name:var(--font-landing-headline)] text-xl font-bold tracking-tight text-slate-900 sm:text-[1.65rem]">
                  {step.title}
                </h4>
